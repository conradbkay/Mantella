...
exports.getProjectMembers = exports.shareProject = exports.getProjectById = exports.kickUserFromProject = exports.leaveProject = exports.joinProject = exports.deleteProject = exports.editProject = exports.createProject = void 0;
const User_1 = require("../models/User");
const Project_1 = require("../models/Project");
const uuid_1 = require("uuid");
const router_1 = require("./router");
const passport_1 = require("../passport");
const generateColumn = (name, id, isInProgress) => ({
    id,
    name,
    collapsedUsers: [],
...
const createProject = async (req, res) => {
    ...
    const user = await User_1.UserModel.findOne({ id: req.user.id });
    if (user) {
        ...
        const [created] = await Promise.all([
            Project_1.ProjectModel.create({
                ...
                users: [user.id],
                columns: [
                    generateColumn('Created', (0, uuid_1.v4)(), false),
                    generateColumn('In Progress', (0, uuid_1.v4)(), true),
                    generateColumn('Created', (0, uuid_1.v4)(), false)
                ],
                lists: [
                    {
...
router_1.router.post('/joinProject', passport_1.isAuthenticated, exports.joinProject);
